...
export default function HodExamTimetable() {
  ...
  const fetchExams = async (isRetry = false) => {
    try {
      ...
      logger.error("HodExamTimetable fetch error", { error: err });
    } finally {
      setLoading(false);
      setIsRetrying(false);
    }
  ...
  const handleViewTimetable = async (exam) => {
    try {
      ...
      setSchedule(null);
      logger.error("HodExamTimetable schedule fetch error", { error: err, examId: exam._id });
    } finally {
  ...
  if (error && !selectedExam) {
    ...
    if (isAuthError) {
      return (
        <div className="hod-exam-timetable-page">
          <ApiError
    ...
    return (
      <div className="hod-exam-timetable-page">
        <div className="hod-exam-timetable-header">
          <Breadcrumb items={breadcrumbItems} />
        </div>
        <div className="hod-exam-timetable-error">
          <ApiError
            title="Loading Error"
            message={error}
            errorCode={errorCode}
  ...
  return (
    <div className="hod-exam-timetable-page">
      ...
      <motion.div
        ...
        className="hod-exam-timetable-content"
      >
        {!selectedExam ? (
          <>
            <div className="hod-exam-timetable-title-row">
              <div>
                <h2 className="hod-exam-timetable-title">Published Exam Timetable</h2>
                <p className="hod-exam-timetable-subtitle">
                  View published exam schedules for your department courses.
                </p>
              </div>
            </div>
          ...
          <div className="hod-exam-timetable-detail">
            ...
            {scheduleError && !scheduleLoading && (
              <div className="hod-exam-timetable-schedule-error">
                <FaExclamationTriangle className="hod-exam-timetable-error-icon" />
                <p>{scheduleError.message}</p>
                <button
                  type="button"
                  className="hod-exam-timetable-retry"
            ...
            {!scheduleLoading && !scheduleError && !schedule && (
              <div className="hod-exam-timetable-no-schedule">
                <FaBook />
      ...
      <style>{`
        .hod-exam-timetable-page {
          padding: 1.5rem;
          max-width: 1200px;
          margin: 0 auto;
        }

        .hod-exam-timetable-header {
          margin-bottom: 1.25rem;
        }

        .hod-exam-timetable-content {
        ...
        .hod-exam-timetable-subtitle {
          color: #64748b;
          font-size: 0.95rem;
          margin: 0.25rem 0 0;
        }

        .hod-exam-timetable-error {
          margin-top: 2rem;
        }

        .hod-exam-timetable-detail {
        ...
        .hod-exam-timetable-error-icon {
          font-size: 1.25rem;
          flex-shrink: 0;
        }

        .hod-exam-timetable-retry {
          margin-left: auto;
        ...
        .hod-exam-timetable-retry:hover {
          background: #fef2f2;
        }

        .hod-exam-timetable-no-schedule {
          text-align: center;
          padding: 2rem;
          color: #64748b;
          background: #fff;
        ...
        .hod-exam-timetable-no-schedule svg {
          font-size: 2rem;
          color: #94a3b8;
        }
