...
export default function MyAttendance() {
  ...
  const fetchAttendance = async () => {
    ...
    try {
      ...
      const totalLectures = res.data.attendance.reduce((sum, sub) => sum + (sub.totalLectures || 0), 0);
      const totalPresent = res.data.attendance.reduce((sum, sub) => sum + (sub.present || 0), 0);
      const totalAbsent = res.data.attendance.reduce((sum, sub) => sum + (sub.absent || 0), 0);
      ...
      toastError(err.response?.data?.message || "Failed to load attendance data");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="col-md-8">
            <div className="card border-0 shadow-lg rounded-4">
              <div className="card-body p-5 text-center">
                ...
                <p className="text-muted small">Fetching your attendance data from all subjects</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="container-fluid py-3 py-md-4 animate-fade-in">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted mb-0 small">
                ...
                {studentProfile?.fullName || user.name || "Student"} | Overall: {overallStats.overallPercentage}%
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          ...
          <div className="dropdown">
            ...
            <ul className="dropdown-menu">
              <li><button className="dropdown-item d-flex align-items-center gap-2" onClick={() => window.print()}><FaPrint /> Print Report</button></li>
              <li><button className="dropdown-item d-flex align-items-center gap-2"><FaDownload /> Export CSV</button></li>
              <li><button className="dropdown-item d-flex align-items-center gap-2"><FaDownload /> Export PDF</button></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div className="d-flex align-items-start gap-2">
            ...
            <div>
              ...
              <ul className="mb-0 small ps-3">
                <li><strong>Overall Attendance</strong>: Combined percentage across all subjects</li>
                <li><strong>Subject Breakdown</strong>: Detailed attendance per subject with color-coded status</li>
                <li><strong>Status Indicators</strong>: 
                  <ul className="mt-1 mb-0 ps-3">
                    <li><span className="badge bg-success me-1">≥75%</span> - Good Standing (Meets requirement)</li>
                    <li><span className="badge bg-warning me-1">60-74%</span> - Needs Attention (Below requirement)</li>
                    <li><span className="badge bg-danger me-1">&lt;60%</span> - Critical (At risk of debarment)</li>
                  </ul>
                </li>
                <li>Click <FaEye className="mx-1" /> icon to view detailed session history for any subject</li>
                <li>Attendance is updated in real-time after each class session</li>
              </ul>
              <button 
              ...
              <div>
                ...
                <div className="d-flex flex-wrap gap-3">
                  <div className="d-flex align-items-center gap-1">
                    ...
                    <span className="opacity-75">{studentProfile?.course?.name || "Course"}</span>
                  </div>
                  <div className="d-flex align-items-center gap-1">
                    <FaLayerGroup className="text-white opacity-75" /> 
                    <span className="opacity-75">Semester {studentProfile?.currentSemester || "N/A"}</span>
                  </div>
                  <div className="d-flex align-items-center gap-1">
                ...
                <div className="d-flex flex-wrap gap-2 mt-2">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <span className="opacity-75">Subjects: {attendance.length}</span>
                  </div>
                  <div className="d-flex align-items-center gap-2">
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center text-center text-md-start">
            <div className="d-flex flex-wrap justify-content-center justify-content-md-start gap-4 mb-2 mb-md-0">
              <div className="d-flex align-items-center gap-2">
                ...
                <span className="fw-medium">Total Present: {overallStats.totalPresent}</span>
              </div>
              <div className="d-flex align-items-center gap-2">
                <FaTimesCircle className="text-danger" /> 
                <span className="fw-medium">Total Absent: {overallStats.totalAbsent}</span>
              </div>
              <div className="d-flex align-items-center gap-2">
                <FaBookOpen className="text-primary" /> 
                <span className="fw-medium">Total Lectures: {overallStats.totalLectures}</span>
              </div>
            </div>
        ...
        <div className="card-body p-4">
          <div className="d-flex flex-column flex-md-row align-items-center justify-content-between">
            <div className="text-center mb-4 mb-md-0">
              ...
              <span className={`badge bg-${getAttendanceColor(overallStats.overallPercentage)} mt-2`}>
            ...
            <div className="w-100 mt-4 mt-md-0">
              <div className="d-flex justify-content-between mb-2">
                ...
                <span className="fw-bold text-primary">{overallStats.overallPercentage}%</span>
              </div>
              <div className="progress" style={{ height: '24px', borderRadius: '12px', overflow: 'hidden' }}>
                ...
                >
                  <div className="progress-text">{overallStats.overallPercentage}%</div>
                </div>
              </div>
              ...
              <div className="alert alert-info bg-info bg-opacity-10 mt-4 p-3 rounded-3">
                <div className="d-flex align-items-start gap-2">
                  ...
                  <div>
                    <strong>Minimum Requirement:</strong> 75% attendance is mandatory to be eligible for examinations. 
                    {overallStats.overallPercentage < 75 && (
                      <>
                        <br /><strong className="text-danger">Action Required:</strong> Your current attendance is below minimum requirement. Contact your department for attendance improvement plan.
                      </>
                    )}
                  </div>
                </div>
      ...
      {/* ================= ATTENDANCE TABLE ================= */}
      <div className="card border-0 shadow-lg rounded-4 overflow-hidden animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="card-body p-0">
          {attendance.length === 0 ? (
            <div className="text-center py-5 px-3">
              ...
              <p className="text-muted mb-4">Your attendance records will appear here once teachers start marking attendance for your classes.</p>
              <button 
              ...
              <table className="table table-hover align-middle mb-0">
                <thead className="table-light">
                  <tr>
                    ...
                    <th width="10%" className="text-center pe-4">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {attendance.map((subject, idx) => (
                    ...
                    >
                      ...
                      <td>
                        ...
                        <small className="text-muted">{subject.teacher || "N/A"}</small>
                      </td>
                      <td className="fw-medium">{subject.subjectCode || "N/A"}</td>
                      <td className="text-center fw-medium">{subject.totalLectures || 0}</td>
                      <td className="text-center text-success fw-medium">{subject.present || 0}</td>
                      <td className="text-center text-danger fw-medium">{subject.absent || 0}</td>
                      <td className="text-center">
                        <div className="d-flex flex-column align-items-center">
                          <span className={`badge bg-${getAttendanceColor(subject.percentage)} fw-bold`}>
                            {subject.percentage || 0}%
                          </span>
                          <small className={`mt-1 ${
                            subject.percentage < 60 ? 'text-danger fw-semibold' : 
                            subject.percentage < 75 ? 'text-warning' : 'text-success'
                          }`}>
                      ...
                      <td className="text-center pe-4">
                        <button
                          ...
                          onClick={() => navigate(`/student/my-attendance/${subject.subjectCode}`)}
          ...
          <div className="card-footer bg-light py-3">
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
              <div className="text-muted small mb-2 mb-md-0">
                <strong>Note:</strong> Attendance below 75% may affect exam eligibility. Contact department for attendance regularization.
              </div>
              <div className="d-flex gap-2">
                <button 
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div className="text-center text-md-start">
              ...
              <p className="mb-0">
                <small className="text-muted">
                  <FaSync className="spin-icon me-1" />
                  Attendance data last updated: <strong>{new Date().toLocaleString()}</strong>
                </small>
              </p>
            </div>
