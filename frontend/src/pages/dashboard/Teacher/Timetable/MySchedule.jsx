...
//   const [creating, setCreating] = useState(null);
//   const [currentTime, setCurrentTime] = useState(new Date());
//   const [activeSessions, setActiveSessions] = useState({}); // Track active sessions by slot ID
//   const [attendanceSessions, setAttendanceSessions] = useState({}); // Track existing attendance
//   const navigate = useNavigate();
...
//           if (session.slot_id) {
//             sessionsMap[session.slot_id] = session;
//             attendanceMap[session.slot_id] = session;
//           }
//         });
//       }
...
//   let buttonState = 'start'; // start, active, ended, creating
