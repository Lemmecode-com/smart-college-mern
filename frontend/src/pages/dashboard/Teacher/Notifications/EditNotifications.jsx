    ...
    <AnimatePresence mode="wait">
      ...
      >
          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  You are editing notification:{" "}
                  <strong>
                    "{currentNotification?.title || "Loading..."}"
                  </strong>
                  .
                ...
                <div
                  style={{
                    ...
                    boxShadow: isFullscreen
                      ...
                      : "0 4px 12px rgba(26,75,109,0.15)",
                  }}
                >
                  <FaBell />
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    >
                      <span>
                        ...
                        <span
                          ...
                          style={{ color: BRAND_COLORS.danger.main }}
                        >
                          *
                        </span>
                      </span>
                      <small
                        className={`text-${form.title.length > 80 ? "danger" : form.title.length > 60 ? "warning" : "muted"}`}
                        style={{
                          color:
                  ...
                  <div className="mb-4" style={{ marginBottom: "1.5rem" }}>
                    ...
                    >
                      ...
                      <small
                        className={`text-${form.message.length > 800 ? "danger" : form.message.length > 600 ? "warning" : "muted"}`}
                        style={{
                          color:
                          ...
                          return (
                            <motion.button
                              ...
                              style={{
                                ...
                                borderRadius: "12px",
                                backgroundColor:
                                  form.type === key ? config.bg : "#f8fafc",
                                border: `2px solid ${form.type === key ? config.color : "#e2e8f0"}`,
                                color:
                                  form.type === key ? config.color : "#4a5568",
                  ...
                  <div className="mb-4" style={{ marginBottom: "1.5rem" }}>
                    ...
                    >
                      <FaInfoCircle
                        ...
                        style={{ color: BRAND_COLORS.primary.main }}
                      />
                      Notification will be hidden after this date. Leave blank
                      for no expiry.
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span>
                          This update will be visible to all recipients
                          immediately after saving. Please review all changes
        ...
        {!isFullscreen && (
          ...
          >
            <p style={{ margin: 0 }}>
              © {new Date().getFullYear()} NOVAA Attendance Management System •
              Professional Notification Editor
            </p>
          </div>
        )}
      </motion.div>
