...
import { FaCheckCircle, FaExclamationTriangle, FaTimes, FaUsers, FaSearch, FaUndo, FaSave, FaUserCheck, FaUserTimes, FaChevronLeft, FaCalendarAlt, FaClock } from "react-icons/fa";
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        ...
        // ✅ AUTO-MARK ALL AS PRESENT BY DEFAULT (most common workflow)
        const defaultAttendance = {};
        studentsRes.data.forEach(student => {
          defaultAttendance[student._id] = 'PRESENT';
        });
        setAttendance(defaultAttendance);
        setHasChanges(true); // Mark as changed since we have defaults
      } catch (err) {
      ...
      <div className={`modal-container attendance-modal ${closing ? 'closing' : ''}`}>
        ...
        <div className="modal-header-custom">
          <div className="modal-title-wrapper">
            ...
            <div>
              <h5 id="modal-title" className="modal-title">Mark Attendance</h5>
          ...
          <div className="quick-actions-bar">
            ...
            <div className="progress-info">
              <span className="progress-text">
                <FaCheckCircle className="status-icon present" /> {presentCount}
                <FaTimesCircle className="status-icon absent" /> {absentCount}
              </span>
